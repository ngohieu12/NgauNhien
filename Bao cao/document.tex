...
\begin{align*}
 ...
 \section{Quy hoạch tuyến tính cho chi phí có chiết khấu}
   ...
   \end{shaded*}
  Xét tập được tạo bởi tất cả các hàm thỏa mãn Tính chất 2.5, sau đó từ Tính chât 2.1 ta biết rằng giá trị tối ưu $v^\alpha$ thuộc tập trên. Tính chất 2.6 cho biết hàm lớn nhất trong tập trên chính là $v^\alpha$. Nói cách khác, 1$\alpha$ là nghiệm tối ưu của bài toán
